...
public class SpuDTO extends BaseDTO {
    ...
    @NotEmpty(message = "标题不能为空", groups = {BaiDuOperation.add.class})
    ...
    @NotNull(message = "1级类目id不能为空",groups = {BaiDuOperation.add.class})
    private Integer cid1;

    @ApiModelProperty(value = "2级类目id", example = "1")
    @NotNull(message = "2级类目id不能为空",groups = {BaiDuOperation.add.class})
    private Integer cid2;

    @ApiModelProperty(value = "3级类目id", example = "1")
    @NotNull(message = "3级类目id不能为空",groups = {BaiDuOperation.add.class})
    private Integer cid3;

    @ApiModelProperty(value = "商品所属品牌id", example = "1")
    @NotNull(message = "商品所属品牌id不能为空",groups = {BaiDuOperation.add.class})
